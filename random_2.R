...
test_function <- function(matrix){
  ...
  for (i in 1:10000){
    NUTS_2$random <- rnorm(281, mean = 100, sd = 2)
    moran <- Moran.I(NUTS_2$random, matrix)
...
data_1 <- test_function(elso_szomszed_2)
data_2 <- test_function(masod_szomszed_2)
data_3 <- test_function(regio_kozep_tav_2)
data_4 <- test_function(kozut_elsodleges_km_2)
data_5 <- test_function(kozut_elsodleges_ora_2)
data_6 <- test_function(kozut_masodlagos_km_2)
data_7 <- test_function(kozut_masodlagos_ora_2)
data_8 <- test_function(min_tav_2)
data_9 <- test_function(legkozelebbi_negy_2)
...
nrow(data %>% filter(level == "elsődleges szomszédság") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "másodlagos szomszédság") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "régióközép távolság") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "közút - elsődleges - km") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "közút - elsődleges - h") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "közút - másodlagos - km") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "közút - másodlagos - h") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "legkisebb távolság") %>% select(p_value) %>% filter(p_value < 0.005))/100
nrow(data %>% filter(level == "4-legközelebbi szomszéd") %>% select(p_value) %>% filter(p_value < 0.005))/100

nrow(data %>% filter(level == "elsődleges szomszédság") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "másodlagos szomszédság") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "régióközép távolság") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "közút - elsődleges - km") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "közút - elsődleges - h") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "közút - másodlagos - km") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "közút - másodlagos - h") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "legkisebb távolság") %>% select(p_value) %>% filter(p_value < 0.001))/100
nrow(data %>% filter(level == "4-legközelebbi szomszéd") %>% select(p_value) %>% filter(p_value < 0.001))/100
...
save.image("d:/Users/Fanni/Desktop/Területi autokorreláció/random_2_2.RData")
load("d:/Users/Fanni/Desktop/Területi autokorreláció/random_2_2.RData")